...
const PremiumInput = (props: React.InputHTMLAttributes<HTMLInputElement>) => (
  <input
    className="w-full h-14 bg-[#161618] border border-zinc-800 rounded-2xl px-5 text-sm font-semibold text-zinc-100 outline-none focus:border-[#820AD1] focus:shadow-[0_0_0_1px_rgba(130,10,209,0.1)] transition-all placeholder:text-zinc-600"
    {...props}
  />
);
        ...
        <header className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div className="space-y-2">
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm font-black tracking-widest text-[#820AD1]">
                SERVICE CENTER
              </span>
            </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="h-12 px-8 rounded-2xl bg-[#820AD1] text-white hover:bg-[#9D3BE1] shadow-[0_0_20px_rgba(130,10,209,0.3)] text-sm font-bold flex items-center gap-2 transition-all active:scale-95"
            >
          ...
          <div className="p-10 space-y-8">
            ...
            <div className="flex gap-3 pt-2">
              ...
              <button
                ...
                className="flex-[2] h-12 rounded-2xl bg-[#820AD1] text-white hover:bg-[#9D3BE1] text-sm font-black uppercase tracking-[0.2em] flex items-center justify-center gap-2 transition-all active:scale-95 disabled:opacity-50"
              >
                {create.isPending ? (
                  <Loader2 size={16} className="animate-spin" />
                ) : (
